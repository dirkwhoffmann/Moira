...
#define MOIRA_DECLARE_EXEC4(x) \
template<CPU C, Instr I, Mode M, Size S> void exec##x(u16 op);
...
MOIRA_DECLARE4(AndiRg)
MOIRA_DECLARE(AndiEa)
MOIRA_DECLARE4(Andiccr)
MOIRA_DECLARE4(Andisr)
...
template<CPU C, Instr I, Mode M, Size S> void execMulMusashi(u16 op);
template<CPU C, Instr I, Mode M, Size S> void execDivMusashi(u16 op);
