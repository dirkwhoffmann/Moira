...
#ifdef _MSC_VER
#pragma warning(disable : 4244 4100 4267)
#endif
...
const struct floatformat floatformat_ieee_single_big = { 4 };
const struct floatformat floatformat_ieee_double_big = { 8 };
const struct floatformat floatformat_m68881_ext = { 12 };
